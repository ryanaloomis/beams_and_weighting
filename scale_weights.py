...
def weight_multichan(msfile, npix, cell_size, robust=0., method='briggs', perchanweight=False, mod_pcwd=False, npixels=0):
    tb = casatools.table()
    ms = casatools.ms()
...
weight_multichan("test_r-2_c0.02_mod.ms", npix=1024, cell_size=0.02, robust=-2., method='briggs', perchanweight=True, mod_pcwd=True, npixels=0)
weight_multichan("test_r0_c0.02_mod.ms", npix=1024, cell_size=0.02, robust=0., method='briggs', perchanweight=True, mod_pcwd=True, npixels=0)
weight_multichan("test_r0.5_c0.02_mod.ms", npix=1024, cell_size=0.02, robust=0.5, method='briggs', perchanweight=True, mod_pcwd=True, npixels=0)
weight_multichan("test_r1_c0.02_mod.ms", npix=1024, cell_size=0.02, robust=1., method='briggs', perchanweight=True, mod_pcwd=True, npixels=0)
weight_multichan("test_r2_c0.02_mod.ms", npix=1024, cell_size=0.02, robust=2., method='briggs', perchanweight=True, mod_pcwd=True, npixels=0)
